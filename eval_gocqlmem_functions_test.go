...
func TestCast(t *testing.T) {
	...
	testValues := []testPairValue{
		...
		{int(101), DataTypeDecimal, "", decimal.NewFromInt(101)},
		{int8(12), DataTypeDecimal, "", decimal.NewFromInt(12)},
		{int16(103), DataTypeDecimal, "", decimal.NewFromInt(103)},
		{int32(104), DataTypeDecimal, "", decimal.NewFromInt(104)},
		{int64(105), DataTypeDecimal, "", decimal.NewFromInt(105)},
...
func TestMathFunctions(t *testing.T) {
	...
	testValues = []testValue{
		...
		{decimal.NewFromFloat(-1.1), "", decimal.NewFromFloat(0.3328710836980795)},
	}
	...
	testValues = []testValue{
		...
		{decimal.NewFromFloat(1.1), "", decimal.NewFromFloat(0.09531017980432493)},
	}
	...
	testValues = []testValue{
		...
		{decimal.NewFromFloat(-1.5), "", decimal.NewFromFloat(-2)},
	}
